...
const ROS2_GENERATOR_CORE = {
    ...
    getRosPackages(distro, packages) {
        const map = {
            ...
            gazebo: distro === 'jazzy'
                ? [] // Gazebo Classic is EOL on Jazzy (Ubuntu 24.04)
    ...
    buildDockerfile(config) {
        ...
        lines.push(`# Generated by ROS2 Docker Generator`);
        lines.push(`# =============================================================`);
        lines.push('');
    ...
    buildCompose(config) {
        ...
        const lines = [];
        lines.push(`# docker-compose.yml — generated by ROS2 Docker Generator`);
        lines.push(`services:`);
...
Generated by [ROS2 Docker Generator]
...
---
*Generated by ROS2 Docker Generator Portfolio Tool*
`;
    }
};
